...
This space is designed to be a <Linktip tiptext="For more information on this topic, check out my working notes.">[digital garden](/notes/digital-garden)</Linktip>. The goal is to combine <Linktip tiptext="Delineated by these blue highlights">[notes](/notes)</Linktip> and more <Tooltip tiptext={<span>like my <a href="/articles">Articles</a> or <a href="/poetry">Poetry</a></span>}>finished pieces</Tooltip> into an organic space that grows as I work and tend it.
