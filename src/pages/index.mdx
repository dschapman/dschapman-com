...
This space is designed to be a <Tooltip tiptext="For more information on this topic, check out my working notes.">[digital garden](/notes/digital-garden)</Tooltip>. The goal is to combine <Tooltip tiptext="Delineated by these blue highlights">[notes](/notes)</Tooltip> and more <Tooltip tiptext={<span>like my <a href="/articles">Articles</a> or <a href="/poetry">Poetry</a></span>}>finished pieces</Tooltip> into an organic space that grows as I work and tend it.
