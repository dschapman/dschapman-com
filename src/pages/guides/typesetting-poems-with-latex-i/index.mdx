...
image: "/guides/typesetting-poems-with-latex-i/card.png"
...
To add a title, just place the command `\\poemtitle{Pied Beauty}` before the beginning of the poem, and all that we're missing is the poem. 

For this example, I'm going to use Gerard Manley Hopkin's poem *Pied Beauty* since it allows us to demonstrate two staples of typesetting poetry - stanzas and lines.
...
After copying in the poem and using these commands our document should look something like this:
